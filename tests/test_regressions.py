...
def test_publication_guard_rejects_old_schema(tmp_path):
 ...
 for path in ['index.html','assets/app.js','assets/math.js','assets/decision.js','assets/research.js','assets/forecastex.js','assets/app.css']:(tmp_path/'docs'/path).write_text('asset')
